...
public class ColorPicker : MonoBehaviour {
	...
	public GameObject receiverL;
	public GameObject receiverR;
	public GameObject receiver2L;
	public GameObject receiver2R;
	...
	public void ApplyColor()
	{
		...
		if(receiverL)
		{
			receiverL.SendMessage(colorSetFunctionName, SelectedColor, SendMessageOptions.DontRequireReceiver);
		}
		if(receiverR)
		{
			receiverR.SendMessage(colorSetFunctionName, SelectedColor, SendMessageOptions.DontRequireReceiver);
		}
		if (receiver2L) {
			receiver2L.SendMessage(colorSetFunctionName, SelectedColor, SendMessageOptions.DontRequireReceiver);
		}
		if (receiver2R) {
			receiver2R.SendMessage(colorSetFunctionName, SelectedColor, SendMessageOptions.DontRequireReceiver);
		}
	}
}
