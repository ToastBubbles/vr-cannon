...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Hand : MonoBehaviour
    {
        ...
        public SteamVR_Action_Boolean touchPad = SteamVR_Input.GetAction<SteamVR_Action_Boolean>("TouchingPad");

        public SteamVR_Action_Boolean grabGripAction = SteamVR_Input.GetAction<SteamVR_Action_Boolean>("GrabGrip");

        public SteamVR_Action_Boolean pingAction = SteamVR_Input.GetAction<SteamVR_Action_Boolean>("Ping");
        ...
        public SteamVR_Action_Vector2 swipeAction = SteamVR_Input.GetAction<SteamVR_Action_Vector2>("SnapTurn");

        public SteamVR_Action_Vector2 locomotion = SteamVR_Input.GetAction<SteamVR_Action_Vector2>("Locomotion");
       // public SteamVR_Action_Vector2 locomotion = SteamVR_Input.GetAction<SteamVR_Action_Vector2>("Locomotion");
        ...
        protected virtual void Update()
        {
            ...
            swipeDelta = swipeAction[SteamVR_Input_Sources.RightHand].axis;

            leftPos = locomotion[SteamVR_Input_Sources.LeftHand].axis;
