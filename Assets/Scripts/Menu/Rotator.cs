...
public class Rotator : MonoBehaviour {
	...
	public Transform targettur2or;
	public Transform targettur2stansel;
	public Transform targettur2wheelsel;
	public Transform targettur2stanor;
	public Transform targetmoror;
	public Transform targetmorstansel;
	public Transform targetmorwheelsel;
	public Transform targetmorstanor;
	public Transform targettur1stanor;
	public Transform targettur1wheelor;
	...
	void Update () {
		...
		if (current == 0 && currentturret == 0) {
			...
			turretmort.transform.position = Vector3.MoveTowards(turretmort.transform.position, targetmoror.position, step);
		}
		...
		if (current == 0 && currentturret == 2) {
			...
			turretStan.transform.position = Vector3.MoveTowards (turretStan.transform.position, targettur2or.position, step);
			turret2.transform.position = Vector3.MoveTowards (turret2.transform.position, targettur2or.position, step);
		}
